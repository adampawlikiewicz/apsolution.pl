...
$contact_email_to = "biuro@apsolution.pl";

// Subject prefix
$contact_subject_prefix = "Wiadomość e-mail od: ";

// Name too short error text
$contact_error_name = "Uzupełnij poprawnie wszystkie pola!";

// Email invalid error text
$contact_error_email = "Wpisz poprawny adres e-mail!";

// Subject too short error text
$contact_error_subject = "Uzupełnij poprawnie wszystkie pola!";

// Message too short error text
$contact_error_message = "Nie wpisano żadnej wiadomości";
